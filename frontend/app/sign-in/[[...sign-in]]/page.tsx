        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-flow {
          ...
          background: linear-gradient(
            125deg,
            rgba(0,180,170,0.05) 0%,
            rgba(0,40,60,0.45) 35%,
            rgba(0,0,0,0.3) 60%,
            rgba(0,180,180,0.06) 100%
          );
          background-size: 300% 300%;
          animation: flowBg 8s ease-in-out infinite alternate;
        }
        @keyframes flowBg {
        ...
        .auth-scanlines {
          ...
          background: repeating-linear-gradient(
            ...
            transparent,
            transparent 2px,
            rgba(0,220,210,0.012) 2px,
            rgba(0,220,210,0.012) 4px
          );
          pointer-events: none;
        }
        ...
        .auth-phase {
          ...
          color: #00ddd0; margin-bottom: 16px;
          display: flex; align-items: center; gap: 10px;
        }
        .auth-phase::before {
          content: ''; width: 32px; height: 1px;
          background: #00ddd0; box-shadow: 0 0 8px #00ddd0;
        }
        ...
        .auth-headline {
          ...
          margin-bottom: 20px;
          text-shadow: 0 0 40px rgba(0,220,210,0.3);
        }
        .auth-headline span {
          color: #00ddd0;
          text-shadow: 0 0 20px #00ddd0, 0 0 40px rgba(0,220,210,0.5);
        }
        ...
        .auth-feature-dot:nth-child(2) { animation-delay: 0.5s; }
        @keyframes pulse {
          0%, 100% { box-shadow: 0 0 6px #00ddd0; }
          50%       { box-shadow: 0 0 14px #00ddd0, 0 0 24px rgba(0,220,210,0.4); }
        }

        /* ── Right panel: glass + flowing effect ── */
        .auth-right {
          width: 460px;
          flex-shrink: 0;
          position: relative;
        ...
        /* Animated flowing glass background */
        .auth-right::before {
          content: '';
          position: absolute;
          inset: 0;
          background: linear-gradient(
            160deg,
            rgba(0, 220, 210, 0.08) 0%,
            rgba(0, 10, 20, 0.55) 40%,
            rgba(0, 180, 160, 0.06) 70%,
            rgba(0, 5, 15, 0.6) 100%
          );
          ...
          border-left: 1px solid rgba(0, 220, 210, 0.18);
        }
        @keyframes glassFlow {
        ...
        /* Teal shimmer line on the left edge of right panel */
        .auth-right::after {
          content: '';
          position: absolute;
          ...
          background: linear-gradient(
            ...
            transparent 0%,
            #00ddd0 25%,
            rgba(0,220,210,0.5) 50%,
            #00ddd0 75%,
            transparent 100%
          );
          box-shadow: 0 0 12px #00ddd0;
        ...
        .auth-right-title {
          ...
          color: #fff; letter-spacing: 0.08em; margin-bottom: 6px;
        }
        .auth-right-sub {
        ...
        .cl-formFieldInput {
          ...
          border: 1px solid rgba(0,220,210,0.25) !important;
        ...
        .cl-formFieldInput:focus {
          border-color: #00ddd0 !important;
          box-shadow: 0 0 0 2px rgba(0,220,210,0.2), 0 0 16px rgba(0,220,210,0.15) !important;
        }
        .cl-formFieldLabel {
        ...
        .cl-formButtonPrimary {
          background: linear-gradient(135deg, rgba(0,180,170,0.9), rgba(0,130,150,0.9)) !important;
          border: 1px solid rgba(0,220,210,0.4) !important;
          font-family: 'Orbitron', monospace !important;
          font-size: 11px !important; letter-spacing: 0.12em !important;
          border-radius: 8px !important;
          box-shadow: 0 4px 20px rgba(0,180,180,0.25), inset 0 1px 0 rgba(255,255,255,0.1) !important;
          backdrop-filter: blur(8px) !important;
          transition: all 0.25s !important;
        }
        .cl-formButtonPrimary:hover {
          box-shadow: 0 4px 32px rgba(0,220,210,0.5), inset 0 1px 0 rgba(255,255,255,0.15) !important;
          transform: translateY(-1px) !important;
        }
        .cl-footerActionLink { color: #00ddd0 !important; }
        .cl-footerAction { color: #ffffff !important; }
        ...
        .cl-socialButtonsBlockButton {
          background: rgba(0,20,30,0.45) !important;
        ...
        .cl-socialButtonsBlockButton:hover {
          background: rgba(0,40,50,0.6) !important;
          border-color: rgba(0,220,210,0.35) !important;
          box-shadow: 0 0 12px rgba(0,220,210,0.15) !important;
        }
        .cl-dividerLine { background: rgba(0,220,210,0.15) !important; }
        .cl-dividerText { color: #ffffff !important; }
        .cl-identityPreviewText { color: rgba(255,255,255,0.7) !important; }
        .cl-identityPreviewEditButton { color: #00ddd0 !important; }
        ...
        @media (max-width: 900px) {
          ...
          .auth-right::before { border-left: none; }
        }
      `}</style>
      ...
      <div className="auth-root">
        ...
        <div className="auth-left">
          ...
          <div className="auth-headline">
            Break the barrier<br />of <span>language</span>
          </div>
          <p className="auth-desc">
            Real-time AI translation for calls, interviews, and conversations.
            Powered by Deepgram and Gemini — speak freely in any language.
          </p>
          <div className="auth-features">
            {[
              "Real-time speech transcription",
              "14 language translation pairs",
        ...
        <div className="auth-right">
          <div className="auth-right-inner">
            <div className="auth-right-header">
              <div className="auth-right-title">SIGN IN</div>
              <div className="auth-right-sub">Access your assistant</div>
            </div>
            <SignIn
              appearance={{
                variables: {
                  ...
                  colorText: "#ffffff",
                  colorPrimary: "#00ddd0",
                  colorInputBackground: "rgba(0,20,30,0.5)",
